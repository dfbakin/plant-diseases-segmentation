"""ResNet-38 backbone for PSA affinity network.

Ported from MCTformer/psa/network/resnet38d.py. Architecture kept intact,
only style cleanup applied. Pretrained weights: pretrained/res38_cls.pth.
"""
...
class ResBlock(nn.Module):
    ...
    def forward(self, x, get_x_bn_relu=False):
        ...
        branch1 = x if self.same_shape else self.conv_branch1(branch2)
...
class ResBlockBot(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1, dilation=1, dropout=0.0):
        ...
        self.dropout_2b1 = nn.Dropout2d(dropout)
        self.conv_branch2b1 = nn.Conv2d(
        ...
        self.dropout_2b2 = nn.Dropout2d(dropout)
...
class Net(nn.Module):
    ...
    def forward_as_dict(self, x):
        ...
        return {"conv4": conv4, "conv5": conv5, "conv6": conv6}
